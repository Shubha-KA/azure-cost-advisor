...
variable "application_gateway_subnet_prefix" { type = string }
variable "private_endpoint_subnet_prefix" { type = string }
variable "create_private_endpoints" { type = bool }
variable "private_dns_zones" { type = map(string) }
...
resource "azurerm_private_dns_zone" "this" {
  for_each = var.create_private_endpoints ? var.private_dns_zones : {}
...
output "application_gateway_subnet_id" { value = azurerm_subnet.application_gateway.id }
